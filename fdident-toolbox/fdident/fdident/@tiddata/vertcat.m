...
%VERTCAT Vertical concatenation of tiddata objects: bypass non-inheritance from iddat
%       [dat1 ; dat2 ...]
...
%warning('tiddata/[] has been called (vertcat)')
...
for ii=2:length(varargin)
  ...
  %
  Out.iddat=[Out.iddat;dat2.iddat];
end %for ii
%
