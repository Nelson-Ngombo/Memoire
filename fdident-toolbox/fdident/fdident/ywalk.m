function [B,A] = ywalk(na, ff, aa, npt, lap)
%YWALK  Recursive filter design using a least-squares method.
%
%       [B,A] = YWALK(N,F,M) finds the N-th order recursive filter
...
%
%       See also: FIR1, BUTTER, CHEBY, FREQZ and FILTER (in the
%                 Signal Processing Toolbox).
%
%   The YWALK function performs a least squares fit in the time domain.
...
%       Copyright (c) 1985-97 by the MathWorks, Inc.
%       Modified 3-5-87 LS
%       Modified 1-8-93 LS, for use in Frequency Domain System Identification
