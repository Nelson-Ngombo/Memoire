function Out = invrepeat_mlbs(tdat)
%INVREPEAT_MLBS  Inverse repeat time series, and change sign of every second sample.
...
if isempty(st1)
  if ~isempty(st2)
    Out.SampleTimes=st2;
    warning('Empty SampleTimes in obj1, values taken from obj2 in @tiddata/horzcat') 
  end
...
%
% end of function @tiddata/invrepeat_mlbs
